function [y_predict, pmask_all] = ...
    cpm_main_pca(x,y,varargin)
...
%% Check for errors
[x,y]=cpm_check_errors_pca(x,y,kfolds);

%% Train & test Connectome-Based Predictive Model
%[y_predict,pmask_pos,pmask_neg,pos_mdl_sz,neg_mdl_sz]=cpm_cv(x,y,pthresh,kfolds);

% Uncomment lines 57-58 for randominzation in permutation testing 
%ridx = randperm(size(y,1));
%y = y(ridx,:);

[y_predict,pmask_all]=cpm_cv_pca(x,y,pthresh,kfolds);
